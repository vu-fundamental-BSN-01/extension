...
gnome-terminal --working-directory=${bsn}/configurations/target_system -e 'roslaunch --pid=/var/tmp/g6w1.pid g6w1.launch'
...
gnome-terminal --working-directory=${bsn}/configurations/target_system -e 'roslaunch --pid=/var/tmp/g5w1_1.pid g5w1_1.launch' & sleep 2s
gnome-terminal --working-directory=${bsn}/configurations/target_system -e 'roslaunch --pid=/var/tmp/g5w1_2.pid g5w1_2.launch' & sleep 2s
gnome-terminal --working-directory=${bsn}/configurations/target_system -e 'roslaunch --pid=/var/tmp/g5w1_3.pid g5w1_3.launch' & sleep 2s
...
kill $(cat /var/tmp/g6w1.pid && rm /var/tmp/g6w1.pid) & sleep 1s
kill $(cat /var/tmp/g5w1_1.pid && rm /var/tmp/g5w1_1.pid) & sleep 1s
kill $(cat /var/tmp/g5w1_2.pid && rm /var/tmp/g5w1_2.pid) & sleep 1s
kill $(cat /var/tmp/g5w1_3.pid && rm /var/tmp/g5w1_3.pid) & sleep 1s
