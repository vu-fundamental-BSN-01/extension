#ifndef CENTRALHUBWEATHER_HPP
#define CENTRALWEATHERHUBWEATHER_HPP
...
class CentralHubWeather : public arch::target_system::Component {

    public:
		CentralHubWeather(int &argc, char **argv, const std::string &name, const bool &active, const bsn::resource::Battery &battery);
    	~CentralHub();

	private:
    	CentralHubWeather &operator=(const CentralHubWeather &);
