#include "component/CentralHubWeather.hpp"
...
int32_t CentralHubWeather::run() {
    ...
    ros::NodeHandle nh;
    ros::Subscriber env_thermometerSub = nh.subscribe("env_thermometer_data", 10, &CentralHubWeather::collect, this);
    ros::Subscriber barometerSub = nh.subscribe("barometer_data", 10, &CentralHubWeather::collect, this);
    ros::Subscriber hygrometerSub = nh.subscribe("hygrometer_data", 10, &CentralHubWeather::collect, this);
