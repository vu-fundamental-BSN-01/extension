...
void WeatherModule::setUp() {
    ...
    std::vector<std::string> splittedVitalSigns = bsn::utils::split(weatherFactors, ',');
...
bsn::generator::DataGenerator WeatherModule::configureDataGenerator(const std::string& vitalSign) {
    srand(time(NULL));
